  ...
  return (
    <section className="relative flex-1 min-h-0 w-full overflow-hidden bg-white">
        ...
        >
          ...
          <div className="relative z-10 h-full flex items-center">
            <div className="w-full max-w-xl lg:max-w-2xl min-w-0 pl-16 sm:pl-20 md:pl-24 lg:pl-28 pr-6 box-border">
              <h1 className="text-primary-500 text-2xl sm:text-3xl md:text-4xl lg:text-[2.75rem] font-semibold leading-snug mb-4">
                {slide.title}
              </h1>
              ...
              <Link
                to="/about"
                className="inline-block px-7 py-2.5 text-sm font-medium text-white bg-primary-500 hover:bg-primary-600 transition-colors rounded-sm whitespace-nowrap"
              >
                Know More
              </Link>
            </div>
      ...
      <button
        type="button"
        onClick={prev}
        className="group absolute left-3 sm:left-5 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-11 md:h-11 rounded-full bg-white border border-gray-200 shadow-md flex items-center justify-center cursor-pointer transition-colors duration-200 hover:bg-primary-500 hover:border-primary-500"
      ...
      <button
        type="button"
        onClick={next}
        className="group absolute right-3 sm:right-5 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-11 md:h-11 rounded-full bg-white border border-gray-200 shadow-md flex items-center justify-center cursor-pointer transition-colors duration-200 hover:bg-primary-500 hover:border-primary-500"
